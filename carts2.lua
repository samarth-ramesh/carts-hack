...
function cart_entity2:on_rightclick(clicker)
...
function cart_entity2:on_activate(staticdata, dtime_s)
...
function cart_entity2:get_staticdata()
...
function cart_entity2:on_detach_child(child)
...
function cart_entity2:on_punch(puncher, time_from_last_punch, tool_capabilities, direction)
	...
	if puncher:get_player_control().sneak then
		...
		if not (creative and creative.is_enabled_for
				...
				or not inv:contains_item("main", "carts:cart2") then
			local leftover = inv:add_item("main", "carts:cart2")
...
function cart_entity2:on_step(dtime)
	rail_on_step(self, dtime)
	rail_sound(self, dtime)
end

minetest.register_entity("carts:cart2", cart_entity2)

minetest.register_craftitem("carts:cart2", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		if carts:is_rail(pointed_thing.under) then
			minetest.add_entity(pointed_thing.under, "carts:cart2")
		elseif carts:is_rail(pointed_thing.above) then
			minetest.add_entity(pointed_thing.above, "carts:cart2")
		else
			return
		end
